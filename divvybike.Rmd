  ...
  This is a Google Data Analytics Course capstone project: case study on Cylclistic bike share.The main objective to Design marketing strategies aimed at converting casual riders into annual members.For better understanding of casual and annual memebers, customers who purchase single-ride or full-day passes are referred to as casual riders. Customers who purchase annual memberships are Cyclistic members. To be specific, a sucessful bike sharing company desires to increase the number of their annual memberships.
  As i learned from the Google Data Analytics Program, I will follow the steps of data analysis: **Ask,Prepare,Process,Analyze,Share and Act**. However,since Act step is for executives to decide, i will not cover that step here. I use **R** programming to solve the case study.
  Datasets for case study:[https://divvy-tripdata.s3.amazonaws.com/index.html].This is a public dataset.
  
#Ask
  Clear goal is to Design marketing strategies aimed at converting casual riders into annual memebers. As a analyst need to understand following questions to build insights,
...
In this case study i upload 4 month dataframes of bike share company for analysis. These dataframe are in csv format.
...
##combine dataframes to one dataframe
  I check the 4 month dataframes column names to join the dataframes to one big dataframe.
...
It's time to share our results and insights.
...
Considering the above results and insights we can suggest the following:
